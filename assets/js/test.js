...
function displayResults() {
    ...
    pageData.forEach(row => {
        ...
        const displayKeys = ['Gene', 'Pop', 'HGVS_NP', 'dbSNP', 'ACMG_Classification'];
...
function showDetailView(rowData) {
    ...
    const geneKeys = ['Gene', 'Pop', 'HGVS_NP', 'dbSNP','ACMG_Classification'];
    const clinicalKeys = ['Gene', 'Pop', 'HGVS_NP', 'dbSNP','ACMG_Classification'];
